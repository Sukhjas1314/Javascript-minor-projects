const paragraphs = [
    ...
    'Sukhs Code Academy is an online learning platform that offers courses in various programming languages, including JavaScript and Android app development. It provides a comprehensive curriculum and interactive coding exercises to help learners build practical skills.',
    ...
    'Sukhs Code Academy offers hands-on projects and coding challenges to reinforce learning and practical application of JavaScript and Android development concepts. These projects help learners build real-world experience and showcase their skills.',
    ...
    'Sukhs Code Academy curriculum covers a comprehensive range of topics in JavaScript, Android app development, and other programming languages. It caters to beginners as well as intermediate and advanced learners, providing a learning path suitable for different skill levels.'
  ];
